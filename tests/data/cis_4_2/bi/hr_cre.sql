Rem
Rem $Header: bi_cre.sql 29-aug-2002.11:44:03 hyeh Exp $
Rem
Rem bi_cre.sql
Rem
...
Rem
Rem    NAME
Rem      bi_cre.sql - Create data objects for BI schema
Rem
Rem    DESCRIPTION
Rem      This script creates six tables, associated constraints
Rem      and indexes in the human resources (BI) schema.
Rem
Rem    NOTES
Rem
...
REM BI.LOCATIONS table has a foreign key to this table.
...
REM OE.CUSTOMERS table and BI.LOCATIONS have a foreign key to this table.
...
REM BI.DEPARTMENTS has a foreign key to this table.
...
REM BI.EMPLOYEES and BI.JOB_HISTORY have a foreign key to this table.
...
REM BI.EMPLOYEES has a foreign key to this table.
...
REM BI.EMPLOYEES has a self referencing foreign key to this table.
...
REM BI.JOBS, BI_DEPARTMENTS, and BI.EMPLOYEES have a foreign key to this table.
