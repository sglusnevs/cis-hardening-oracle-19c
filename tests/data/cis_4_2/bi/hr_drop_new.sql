Rem
Rem $Header: rdbms/demo/schema/bi/bi_drop_new.sql /main/1 2015/11/06 14:31:20 celsbern Exp $
Rem
Rem bi_drop.sql
Rem
...
Rem
Rem    NAME
Rem      bi_drop.sql - Drop objects from BI schema
Rem
Rem    DESCRIPTION
Rem
Rem
...
Rem    dmatisha    10/14/15 - removed line to connect as bi - script should be run as BI user. Removed commit; from end as it is not needed.
